...
import { INSTAGRAM_URL, TIKTOK_URL, FOOTER_WHATSAPP_LINK, EMAIL_URL } from "@/data/services";
  ...
  return (
    <section id="contact" className="py-20 sm:py-28 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        <footer className="mt-12 pt-8 border-t border-border/60 flex flex-col items-center justify-center gap-6 text-sm text-muted-foreground text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-smooth" aria-label="Instagram">
