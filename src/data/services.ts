...
export const NAV_WHATSAPP_LINK = `${WHATSAPP_URL}?text=${encodeURIComponent("السلام عليكم، من خلال موقع إعتماد، أرغب بالاستفسار عن خدماتكم.")}`;
export const FOOTER_WHATSAPP_LINK = `${WHATSAPP_URL}?text=${encodeURIComponent("السلام عليكم، أرغب بالتواصل والحصول على مزيد من التفاصيل حول خدمات التعقيب.")}`;
export const FLOATING_WHATSAPP_LINK = `${WHATSAPP_URL}?text=${encodeURIComponent("السلام عليكم ورحمة الله وبركاته 👋\nأحتاج إلى المساعدة أو الاستفسار بخصوص خدمات إعتماد.")}`;
